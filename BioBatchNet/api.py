...
def correct_batch_effects(data, batch_info, batch_key='batch_id', data_type='imc', 
                         latent_dim=20, epochs=100, loss_weights=None, **kwargs):
    """
    ...
    model.fit(data, batch_labels, epochs=epochs)
