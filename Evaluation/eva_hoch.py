...
from utils import save_adata_dict, load_h5ad_files
...
def main(dataset_name):
    ...
    results_df.to_csv('/mnt/iusers01/fatpou01/compsci01/w29632hl/scratch/code/haiping/scExperiment_IMC/results/hoch/evaluation_results.csv')
    plot_umap_batch_and_celltype(adata_dict, '/mnt/iusers01/fatpou01/compsci01/w29632hl/scratch/code/haiping/scExperiment_IMC/results/hoch/batch.png', '/mnt/iusers01/fatpou01/compsci01/w29632hl/scratch/code/haiping/scExperiment_IMC/results/hoch/cell.png')
    save_adata_dict(adata_dict, '/mnt/iusers01/fatpou01/compsci01/w29632hl/scratch/code/haiping/scExperiment_IMC/results', 'hoch')
